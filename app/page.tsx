...
const productionSteps: { n: string; title: Bilingual; text: Bilingual }[] = [
  ...
  { n: "04", title: { tr: "Storyboard + animatik", en: "Storyboard + animatic" }, text: { tr: "Kamera, bakış, ritim ve davranış okunabilirliği düşük maliyetli aşamada test edilir.", en: "Camera, gaze, rhythm and behavioural readability are tested before costly animation." } },
